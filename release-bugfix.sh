...
echo "2. build nlp4l-framework-${THIS_REL_NUM}.zip file by executing sbt dist. Don't forget to rename application.conf.sample to application.conf before dist."
...
echo -e "\\nThe download link will be  https://github.com/NLP4L/framework/releases/download/rel-${THIS_REL_NUM}/nlp4l-framework-${THIS_REL_NUM}.jar"
